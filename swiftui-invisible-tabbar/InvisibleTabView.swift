 ...
 */
struct InvisibleTabView<SelectionValue: Hashable>: UIViewControllerRepresentable {
    ...
    /**
     ...
     ```
     */
    init(selection: Binding<SelectionValue>, tabs: [(SelectionValue, AnyView)]) {
     ...
     */
    func makeUIViewController(context: Context) -> InvisibleTabController<SelectionValue> {
     ...
     */
    func updateUIViewController(_ uiViewController: InvisibleTabController<SelectionValue>, context: Context) {
 ...
 */
class InvisibleTabController<SelectionValue: Hashable>: UITabBarController, UITabBarControllerDelegate {
     ...
     */
    func setup(tabs: [(SelectionValue, AnyView)], selection: SelectionValue) {
        self.tabItems = tabs
     ...
     */
    func updateSelection(_ newSelection: SelectionValue) {
